		...
		<div id="content">
		  <div class="post">
				...
				<tr>
		  		<td> Usuario: </td>
				<td>
				<input type="text" name="un" style="width: 154px; "/>
				</td>
				</tr>
			<tr>
 		<td>Contraseña:</td><td> <input type="text" name="pw"/>
		</td> </tr>
		<tr><td>
		<input type="submit" value="Nuevo"></td><td> <input type="submit" value="Aceptar"></td> </tr>
		</table></form>
